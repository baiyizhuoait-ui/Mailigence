...
const zh: Dict = {
  ...
  // OAuth callback result (shown on the accounts page)
  "oauth.added": "OAuth 授权成功，账户已添加",
  "oauth.exists": "该邮箱账户已存在，无需重复添加",
  "oauth.stale": "授权流程已结束，请检查下方账户列表；若没有新账户，请重新添加一次",
  "oauth.err.access_denied": "你在授权页面取消了授权，未添加账户",
  "oauth.err.server_error": "登录服务暂时出错，请重试",
  "oauth.err.no_code": "未收到授权码，请重试",
  "oauth.err.token_exchange_failed": "令牌交换失败，请重试",
  "oauth.err.no_refresh_token": "未获得刷新令牌，请重新授权",
  "oauth.err.unknown_platform": "授权失败：未知平台",
  "oauth.err.generic": "授权失败（{code}）",
  "mem.title": "AI 记忆",
  "mem.placeholder": "输入你的邮件偏好…",
  "mem.send": "整理并记住",
  "mem.saved": "已记住，正在重新分类历史邮件",
  "mem.failed": "整理失败：",
  ...
  "idle.events": "IDLE推送",
  "idle.times": "次",
  "idle.pollingOnly": "Outlook（Graph）轮询同步，新邮件约 1 分钟内到达",
  "idle.pollingSync": "轮询同步",
  // Settings page
  ...
  "modal.oauthNotConfiguredOutlook": "Outlook 必须通过 OAuth 连接：请先在 backend/.env 配置 MICROSOFT_OAUTH_CLIENT_ID/SECRET 并重启",
  "modal.oauthNotConfiguredGoogle": "Google OAuth 未配置；Gmail 可用下方应用专用密码连接",
  "modal.cancel": "取消",
  "modal.saving": "验证并保存中…",
  "modal.save": "验证并保存",
  // Import dialog
  ...
  "detail.viewFull": "查看全文",
  "detail.fullLoading": "正在拉取全文…",
  "detail.fullError": "无法获取全文：",
...
const en: Dict = {
  ...
  // OAuth callback result (shown on the accounts page)
  "oauth.added": "OAuth authorized — account added",
  "oauth.exists": "This mailbox is already connected",
  "oauth.stale": "Authorization finished — check the account list below; if no new account appears, add it again",
  "oauth.err.access_denied": "You cancelled the authorization — no account was added",
  "oauth.err.server_error": "Sign-in service had a temporary issue — please retry",
  "oauth.err.no_code": "No authorization code received — please retry",
  "oauth.err.token_exchange_failed": "Token exchange failed — please retry",
  "oauth.err.no_refresh_token": "No refresh token returned — please re-authorize",
  "oauth.err.unknown_platform": "Authorization failed: unknown platform",
  "oauth.err.generic": "Authorization failed ({code})",
  "mem.title": "AI Memory",
  "mem.placeholder": "Type your mail preferences…",
  "mem.send": "Distill & remember",
  "mem.saved": "Saved — re-classifying historical emails",
  ...
  "idle.times": "",
  "idle.pollingOnly": "Outlook (Graph) — polling sync, new mail within ~1 min",
  "idle.pollingSync": "Polling",
  ...
  "modal.oauthNotConfiguredOutlook": "Outlook requires OAuth: configure MICROSOFT_OAUTH_CLIENT_ID/SECRET in backend/.env and restart",
  "modal.oauthNotConfiguredGoogle": "Google OAuth not configured — Gmail works with an app password below",
  "modal.cancel": "Cancel",
  ...
  "detail.viewFull": "View full content",
  "detail.fullLoading": "Fetching full content…",
  "detail.fullError": "Could not fetch full content: ",
